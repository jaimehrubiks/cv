...
\geometry{left=0.8in, right=0.8in, top=0.4in, bottom=0.4in}
...
\begin{tabular}{p{1.5cm}p{14.8cm}}
  ...
  % & \footnotesize{University of the Basque Country} \\
  & \footnotesize{ \begin{itemize}[noitemsep,topsep=3pt]
  \vspace{-0.1in}
  % \item Research Thesis at University of the Basque Country
  % \item Implemented algorithm to early detect and adapt to concept drift
...
\begin{tabular}{rp{13.6cm}}
% \begin{tabular}{p{3.2cm}p{13.1cm}}
\textsc{Jan} 2019 & Extraordinary award by University of the Basque Country \\%\href{https://www.ehu.eus/documents/6810447/9245968/2018+03+20+NdP+Entrega+diplomas+2018.pdf/fe66cb16-e67b-8cb0-01ca-73fe373ce92c}{\hfill | \footnotesize Press report}\\
...
\textsc{Mar} 2018 & \textbf{Rank \#1} in Bachelor's Degree in Telecommunications Engineering \\%\href{https://www.ehu.eus/documents/6810447/9245968/2018+03+20+NdP+Entrega+diplomas+2018.pdf/fe66cb16-e67b-8cb0-01ca-73fe373ce92c}{\hfill | \footnotesize Press report}\\
...
% & \footnotesize{ \hspace{10mm}\emph{ Big Data platforms and sensible to concept drift}'' }\\\vspace{-0.05in}&\\
\vspace{-0.05in}&\\
